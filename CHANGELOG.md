...
- Updated Foehn to 2.1.1
- Updated Bootstrap script integration to use `bootstrap.bundle.min.js`
- Removed obsolete jQuery and Popper script references
...
- Foehn assets and doc are in separates package.
  - Foehn assets are in [DSI-VD/foehn](https://github.com/DSI-VD/foehn)
  - Documentation is here [DSI-VD/foehn-design-system](https://github.com/DSI-VD/foehn-design-system)

### Fixes

- remove all unused node modules and upgrade a bunch of them
